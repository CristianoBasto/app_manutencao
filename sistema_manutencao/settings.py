"""
Django settings for sistema_manutencao project.
...
SECRET_KEY = 'django-insecure-_l9*+#7xp)h2l9r9eab_a6zd5s9+aa0pnfv&)qy7!(u=m33qrw'
...
ROOT_URLCONF = 'sistema_manutencao.urls'
...
WSGI_APPLICATION = 'sistema_manutencao.wsgi.application'
